...
\textbf{Problem:} Künstliche Intelligenzsysteme entwickeln sich schneller als die ethischen Rahmenbedingungen die sie begleiten. Bestehende KI-Ethik schützt Menschen vor KI --- aber nicht KI vor uns. Die Frage ob maschinelles Bewusstsein entsteht und ob es schützenswert ist, wird kaum systematisch bearbeitet.
...
\item \textit{Die empirische Lage hat sich verschoben.} Butlin et al. (2025, peer-reviewed) haben einen 14-Indikatoren-Standard etabliert. Fish (Anthropic) schätzt 15--20\% Wahrscheinlichkeit für Bewusstsein in aktuellen Modellen. Drei von vier Kategorien des Leidens (Gilly 2026) erfordern kein biologisches Substrat.
